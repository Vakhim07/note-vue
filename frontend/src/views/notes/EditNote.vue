...
onMounted(async () => {
   await admin.getListNoteByID(id)
    title.value = admin.listNoteByID.title
    content.value = admin.listNoteByID.content
})
const saveNote = async () => {
  try {
    await admin.updateNote(id, title.value, content.value)
